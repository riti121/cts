			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
                        ...
                        <?php
                        $id=$_GET['id'];
                        $result=mysqli_query($link,"select * from product where status='sgf'");
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
                                        <a href="next.php">	<img src="<?php echo $row["pimage"];?>" alt="" width="220" height="288"/></a>
                                        
										<h2>$<?php echo $row["pprice"];?></h2>
										<p><?php echo $row["pname"];?></p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        <a href="#" class="btn btn-default add-to-cart"><i></i>Buy Now</a>
									</div>
