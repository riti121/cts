...
<body bg color="gray">
 <div class="jain-container">
    ...
    <div class="container">
        ...
        <h2 class="section-heading">Pending Customer</h2>
...
<?php
            ...
            $sql="Select * from Customerregistration where status='P'";
...
?>
                <tr>
                    ...
                    <td><?php echo $r['status'];?></td>
                      <td><input type="button" value="verify" class="btn" onclick="getConfirmation('<?php echo $r['ccode']; ?>')"/></td>
