      ...
      <body bg color="gray">
       <div id="header">
            <div class="row">
               ...
               <div class="col-md-2">
                   <h1 class="ha">TAILOR DASHBOARD</h1>
               </div>
       
           <div class="col-sm-8">
               <a href="TailorLogin.php" class="logout">Logout</a>
           </div>
       </div>
       </div>
          <h1 class="dashboard">Welcome to the Tailor Dashboard...</h1>
          
          <a href="dsorder.php" class="btn btn-success" role="button">See Order</a>
            <div class="container">
     <div class="row">
         <div class="col-md-6">
             <h2 class="heading">Join the CTS and earn money with your creations</h2>
         </div>
         <div class="col-md-6">
             <img src="dashbordimg/images(10).jpg" class="img-circle">
         </div>
     </div>
        <h1 class="h"> Why become a CTS Tailor?</h1>
     <div class="col">
        <div class="row">
            <div class="col-md-6">
                 <h4 class="paragraph">Huge earning</h4>
                 <p class="head">CTS provides the way by which you can earn large money.Because you are connected with the lots of customers.</p>
                 <h4 class="paragraph">High visibility</h4>
                 <p class="head">nnnnnnnnnniiiiihhhh</p>
                 <h4 class="paragraph"></h4>
            </div>
            <div class="col-md-6">
                 <h1 class="paragraph1">Work at your own place</h1>
                 <p class="head">CTS provides the serives that you can work at your own place .There is no chance to live your own place.</p>
                 <h1 class="paragraph">Non-exclusive agreement</h1>
                 <p class="head">There is no agreement problem if you are connecting with CTS.</p>
             </div>
     </div>
     </div>
     <div class="row">
