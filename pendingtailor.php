...
.dropdown:hover>.dropdown-menu{
    ...
    <script>
        function getConfirmation(tcode){''
            var r=confirm("Want to verify the status of pending tailor ? "+tcode);
            if(r==true)
            {
                $.post("verify.php",{tcode:tcode},function(res,status)
                       {
                            
                             if(res=="done")
                                {
                                    location.href="pendingtailor.php";
                                }
                                else
                                {
...
<body bg color="gray">
 <div class="jain-container">
    ...
    <div class="container">
        ...
        <h2 class="section-heading">Pending Tailor</h2>
...
<?php
            ...
            $sql="Select * from Tailorregistration where status='P'";
...
?>           
            <tr>
                  ...
                  <td><?php echo $r['gender'];?></td>
                    ...
                    <td><input type="button" value="Verify" class="btn" onclick="getConfirmation('<?php echo $r['tcode']; ?>')"/></td>
                </tr>
<?php
            }
?>
