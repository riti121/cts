			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Cotton Fabrics</h2>
                        <?php
                        $res=mysqli_query($link,"select * from fabric where status='cf'");
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="../fabric_image/<?php echo $row["fimage"];?>" alt="" />
										<h2>$<?php echo $row["fprice"];?></h2>
									...
									<div class="product-overlay">
										<div class="overlay-content">
											...
											<p><?php echo $row["fname"];?></p>
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                            <a href="#" class="btn btn-default add-to-cart">By Now</a>
