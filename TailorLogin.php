...
if(isset($_POST['login']))
{
    ...
    $query="select * from Tailorregistration where email='$_POST[userid]' && password='$_POST[password]' && status='v'";
...
<form action="TailorLogin.php" method="POST" onsubmit="return validation()">
		<div class="form-div">
  <div class="section-heading"><h2 style="text-align:center;font-family: 'Vast Shadow', cursive;">TAILOR LOGIN</h2></div>
	...
	<div class="form-group details-div">
     ...
     <div  class="msg"><?php echo $message; ?></div>
            ...
            <button class="btn btn-primary" role="button" id="login" name="login" value="login">Login</button>
            <a href="changepasstailor.php" class="btn btn-primary" role="button" id="change" name="change" value="change">Changepassword</a><br />
    <br />
