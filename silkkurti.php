			...
			<div class="container">
				<div class="row">
					<div class="col-md-1">
							...
							<a href="index.html"><img src="images/headimg.png" alt="" width="60px" height="60px" /></a>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
                        ...
                        <?php
                        $id=$_GET['id'];
                        $result=mysqli_query($link,"select * from product where status='sk'");
							...
							<div class="product-image-wrapper">
                                ...
                                <div class="choose">
									<ul>			
										...
										<li><a href="silkfabric.php"><i class="fa fa-plus-square"></i>Select Fabric</a></li>
									</ul>
								</div>
                        </div>
