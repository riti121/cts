...
<div class="row">
  <div class="column">
    <img src="images/shirt1.jpg" style="width:60%" class="img" onclick="openModal();currentSlide(1)" class="hover-shadow cursor"> 
       
  </div>
  <div class="column">
    <img src="images/shirt2.jpg" style="width:60%" class="img" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="images/shirt3.jpg" style="width:60%" class="img" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="images/shirt4.jpg" style="width:60%" class="img" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
  </div>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div class="mySlides">
      ...
      <img src="images/shirt1.jpg" style="width:40%;margin-left:200px ">
       <a href="AdminLogin.php" class="btn btn-primary" role="button">Click here for fabric selection...</a>

    </div>
    <div class="mySlides">
      <div class="numbertext">2 / 4</div>
      <img src="images/shirt2.jpg" style="width:40%">
         <a href="AdminLogin.php" class="btn btn-primary" role="button">Click here for fabric selection...</a>
    ...
    <div class="mySlides">
      ...
      <img src="images/shirt3.jpg" style="width:50%">
         <a href="AdminLogin.php" class="btn btn-primary" role="button">Click here for fabric selection...</a>
    ...
    <div class="mySlides">
      ...
      <img src="images/shirt4.jpg" style="width:50%">
         <a href="fabricshirt.php" class="btn btn-primary" role="button">Click here for fabric selection...</a>
